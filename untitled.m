...
% Last Modified by GUIDE v2.5 12-May-2023 15:13:21
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
ciphertext=get(handles.e4,'string');
k =str2num(get(handles.e5,'string'));
ans2=Dec_Hill(ciphertext,k);
set(handles.e6,'string',num2str(ans2))
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
Plaintext =get(handles.e1,'string');
k =str2num(get(handles.e2,'string'));
ans =Enc_Hill(Plaintext,k);
set(handles.e3,'string',(ans))
